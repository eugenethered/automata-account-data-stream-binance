...
class BinanceAuthenticator(Authenticator):
    ...
    async def authenticate(self):
        self.log.info(f'authenticating... via auth url:{self.auth_url}')
    ...
    async def terminate(self):
        self.log.info(f'terminating authentication... via auth url:{self.auth_url}')
        ...
        self.log.info(f'authentication terminated {status}')
